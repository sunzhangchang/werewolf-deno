import { sendDiscuss, sendHunterWait, sendHunterKilled, updateState, updateWitchState, sendGameEnd, sendWerewolfResult, sendSpecInfo } from './index.ts'
import { loadConfig, ConfigType } from './config.ts'
